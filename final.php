    ...
    <div class="container current-page">
       <nav>
         <div class="nav-wrapper">
           <div class="col s12">
             <a href="index" class="breadcrumb">Trang Chủ</a>
             <a href="cart" class="breadcrumb">Giỏ Hàng</a>
             <a href="checkout" class="breadcrumb">Thanh Toán</a>
             <a href="final" class="breadcrumb">Cảm Ơn</a>
           </div>
         </div>
       </nav>
     </div>
...
<div class="container thanks">
  ...
  <div class="card center-align">
   ...
   <div class="center-align">
     <a href="details.php" class="button-rounded blue btn waves-effects waves-light">Chi Tiết</a>
     <a href="index" class="button-rounded btn waves-effects waves-light">Trang Chủ</a>
   </div>
  </div>
  <div class="col s12 m3">

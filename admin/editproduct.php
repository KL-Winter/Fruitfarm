      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="infoproduct" class="breadcrumb">Sản Phẩm</a>
            <a href="editproduct" class="breadcrumb">Đặt Hàng</a>
          </div>
        </div>
      </nav>
    </div>
    ...
    <div class="card">
      ...
      <div class="row">
        ...
        <div class="input-field col s3">
          ...
          <label for="icon_prefix">Số Lượng Sản Phẩm</label>
        </div>
      ...
      <div class="center-align">
        <button type="submit" name="done" class="waves-effect button-rounded waves-light btn">Lưu</button>
      </div>
    </div>
    <?php  }

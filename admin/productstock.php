      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="products" class="breadcrumb">Sơ Đồ</a>
            <a href="productstock" class="breadcrumb">Các Sản Phẩm</a>
          </div>
        </div>
      </nav>
    </div>
               ...
               <div class="card-image">
                 ...
                 <div class="card-content">                      
                   <span class=" grey-text"><?= $name; ?> <span class="pull-right"><?= $qty; ?> left</span></span>
                      ...
                      <a class="red-text" href="deleteproduct.php?id=<?= $id_product;?>">Xóa</a>

      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="editprofile" class="breadcrumb">Chỉnh Sửa Hồ Sơ</a>
          </div>
        </div>
      </nav>
    </div>
       ...
       <div class="input-field col s12 meh">
         ...
         <label for="icon_prefix">Confirm Password</label>
           ...
           <div class="center-align">
               <button type="submit" id="confirmed" name="update" class="btn meh button-rounded waves-effect waves-light ">Gửi</button>
           </div>

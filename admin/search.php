  ...
  <nav>
    <div class="nav-wrapper">
      <div class="col s12">
        ...
        <a href="search" class="breadcrumb">Tìm Kiếm</a>
      </div>
    </div>
  </nav>
</div>
...
<div class="container search-page">
 <div class="row">
  <div class="col-md-12" style="margin-bottom: 10px;padding-top: 10px;">
    <h4 class="animated slideInUp wow">Kết Quả Cho '<?= $word ?>' </h4>
  </div>
  <?php
  ...
  <table class="highlight striped">
    <thead>
      <tr>
        ...
        <th data-field="user">Khách Hàng</th>
        <th data-field="address">Địa Chỉ</th>
        <th data-field="phone">SĐT</th>
        <th data-field="statut">Trạng Thái</th>
        <th data-field="delete" colsp an="2">Hoạt Động</th>
      </tr>
    </thead>
    <tbody>

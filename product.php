      ...
      <nav>
        <div class="nav-wrapper">
          <div class="col s12">
            ...
            <a href="product.php?id=<? $id_product; ?>" class="breadcrumb">Sản Phẩm</a>
          </div>
        </div>
      </nav>
    </div>
   ...
   <div class="row">
     ...
     <div class="col s12 m6">
       ...
       <div class="center-align">
           <button type="submit" name="buy" class="btn-large meh button-rounded waves-effect waves-light ">Thêm vào giỏ</button>
       </div>
       </div>
        </form>
     </div>

      ...
      <div class="nav-wrapper">
        <form method="GET" action="search.php">          
          <div class="input-field">            
            <input id="search" class="searchings" type="search" name='searched' placeholder="Tìm kiếm" required>
...
<div class="container ">
  ...
  <div class="col-md-12" style="margin-bottom: 50px;padding-top: 10px;">
      <h4 class="animated slideInUp wow">Mặt Hàng Bán Chạy</h4>
  </div>
    <?php
                ...
                <div class="card-image">
                  ...
                  <div class="card-content">
                    <div class="container">
                      <div class="row">
                        <div class="col s6">
                          <p class="black-text">VNĐ <?= $price_best; ?></p>
                        </div>
                        <div class="col s6">
...
<hr>
          ...
          <div class="col-md-12" style="padding-bottom: 10px;padding-top: 10px;">
              <h4 class="animated slideInUp wow center-align">Tất Cả Sản Phẩm</h4>
          </div>
      ...
      <div class="col m10 m10 ">
        ...
        <div class="row">
                    ...
                    <div class="card-image">
                      ...
                      <div class="card-action">
                        <div class="container-fluid">                        
                          ...
                          <h5 class="grey-text">VNĐ <?= $price_product; ?></h5>
                        </div>
                      </div>
                  </div>
                </div>
          ...
          <div class="container-fluid center-align categories">
            <a href="#category" class="button-rounded btn-large waves-effect waves-light">Phân Loại</a>
              ...
              <div class="container-fluid about" id="about">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col s12 m6">
                      <h3 class="animated slideInUp wow">Về chúng tôi</h3>
                      <div class="divider animated slideInUp wow"></div>
                      <p class="animated slideInUp wow black-text">Chúng tôi là một trang web bán trái cây có liên quan đến giáo dục sức khỏe về lợi ích của trái cây. Chúng tôi cũng hợp tác với các nhà cung cấp trái cây để cung cấp chúng cho những người dùng muốn sống một cuộc sống lành mạnh hơn.
</p>
                      </div>
                  ...
                  <div class="row">
                    <form class="col s12 animated slideInUp wow">
                      <div class="row">
                        ...
                        <div class="center-align">
                          <button type="submit" name="contact" class="button-rounded btn-large waves-effect waves-light">Gửi</button>
                        </div>
                      </div>
                    </form>
                  </div>
